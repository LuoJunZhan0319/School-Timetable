...
#提取使用者post資料，並於資料庫查詢
$search_weeknum = $_POST["weeknum"];
$search_classnum = $_POST["classnum"];
$search_classname = $_POST["classname"];

$sql = "SELECT teacherid , teachername, classname FROM `teacherandclass` 
WHERE teacherid <> ALL 
(SELECT teacherid 
FROM `teacherandclass` 
WHERE weeknum = $search_weeknum && classnum = $search_classnum) && classname LIKE '".$search_classname."' 
GROUP BY teacherid;";
